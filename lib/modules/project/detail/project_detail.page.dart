...
import 'package:job_timer/core/ui/job_timer_icons.dart';
import 'package:job_timer/modules/project/detail/controller/project_detail_controller.dart';
import 'package:job_timer/modules/project/detail/widgets/project_detail_appbar.dart';
import 'package:job_timer/modules/project/detail/widgets/project_pie_chart.dart';
import 'package:job_timer/modules/project/detail/widgets/project_task_tile.dart';
...
class ProjectDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // BlocConsumer ele fica escutando e atualiza a página como um todo
          ...
          delegate: SliverChildListDelegate(
            [
              ...
              ...projectModel.tasks
                  ...
                  .toList(), //Pesquisar sobre Destruction
            ],
          ),
        ),
